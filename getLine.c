#include "shell.h"
/**
 * input_buf - stores chained commands
...
/**
 * get_input - removes the new line
 * @info: pointer to structure info
 * Return: bytes read
 */
 ...
 * @info: point5er to info structure
